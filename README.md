...
The SPHINCS- C6 verifier is **deployed once** and shared by all accounts. Each account stores its own public keys (`pkSeed`, `pkRoot`) and calls the shared verifier with its keys as arguments. Follows the [ZKnox/Kohaku]([https://github.com/ethereum/kohaku](https://github.com/ethereum/kohaku/tree/master/examples/pq-account)) pattern.
