...
/// @notice End-to-end test of the JARDIN-Keccak-128-24 verifier against
///         real signatures produced by our forked sphincsplus-derived C
///         binary (signers/jardin-keccak-128-24/jardin-keccak-128-24).
///
///         `script/slh_dsa_keccak_128_24_fast_signer.py` caches fixture
///         signatures to disk (signers/jardin-keccak-128-24/.cache/) so
///         later test runs don't pay the ~11-min C-signer cost.
contract SLH_DSA_Keccak_128_24_Test is Test {
    ...
    function testValidSignature() public view {
        ...
        assertTrue(
            ...
            "JARDIN-Keccak-128-24 signature should verify"
        );
    }
    ...
    function testVerifyGas() public {
        ...
        emit log_named_uint("JARDIN-Keccak-128-24 verify gas", gasUsed);
    }
    ...
    function testRejectsTamperedFORSSecret() public view { _assertTamperFails(16 + 2 * 400); }
    function testRejectsTamperedWOTSChain()  public view { _assertTamperFails(16 + 2400 + 100); }
    function testRejectsTamperedXMSSAuth()   public view { _assertTamperFails(16 + 2400 + 1088 + 16); }
}
