...
def cmd_create(args):
    ...
    variant_num = {"c2": 2, "c6": 6}[args.variant]
...
def main():
    ...
    p_create.add_argument("--variant", choices=["c2", "c6"], default="c2", help="SPHINCS+ variant")
    ...
    p_send.add_argument("--variant", choices=["c2", "c6"], default="c2", help="SPHINCS+ variant")

    # info
    p_info = sub.add_parser("info", help="Show account info")
    p_info.add_argument("--ecdsa-key", required=True, help="ECDSA private key (hex)")
    p_info.add_argument("--variant", choices=["c2", "c6"], default="c2", help="SPHINCS+ variant")
